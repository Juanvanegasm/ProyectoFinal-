...
public class ControlRegistro {
    ...
    public void registrarEntrada(Computador computador) {
        ...
        RegistroEntrada registroEntrada = new RegistroEntrada(computador, fecha); // Corregido aquí
    ...
    public void mostrarActivos() {
        ...
        for (Registro registro : registros) {
            if (!estaSalidaRegistrada(registro.getComputador().getSerial())) {
                registro.mostrarDetalle();
                System.out.println("-------------------------");
            }
        }
    ...
    private Computador buscarComputadorActivo(String serial) {
        for (Registro registro : registros) {
            if (registro.getComputador().getSerial().equals(serial) &&
    ...
    private boolean estaSalidaRegistrada(String serial) {
        for (Registro registro : registros) {
            if (registro instanceof RegistroSalida &&
